...
這麼強悍有霸氣的標語，能喊出來的應該沒幾個，而我相信Elastic真真切切有資格稱為即時搜尋和分析資料引擎的領導者。去年底因為一些機緣，開啟了Elasticsearch、Logstash、Kibana的學習過程，也碰巧開始關注ELK的發展，忽然發現有一場研討會在台北，速速點選報名，希望能有更伸更多的瞭解。
