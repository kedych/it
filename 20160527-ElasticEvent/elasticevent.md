...
也可以感覺到Elastic社群的活力，相信這會是很值得投入的一塊，至少，在資管部現有的環境裡面，把Log收好收滿，再盡可能的找出有意義的分析或者設計告警等。更希望自己做好以後，能夠應用Elastic Stack到報系其他會有各種數據的關係企業，例如分析udn.com的內容(可能看看GA之外還有什麼?)、電子商務部消費分析、客戶關係服務CRM想做的事情等，有沒有什麼是我們能夠使得上力的地方，讓我們能走得更高更遠，更有價值。